...
function japanese_rightMenu(){
  ...
  right.innerHTML = `<button type="button" class="btn btn-item" id="btn1" onclick="location.href='./page1.html'">自学の活動とは</button>\
                     ...
                     <button type="button" class="btn btn-item" id="btn7" onclick="location.href='./page7.html'">自律学習実践研究会</button>\
...
function chinese_rightMenu(){
  var right = document.getElementById("rightMenu")
  right.innerHTML = `<button type="button" class="btn btn-item" id="btn1" onclick="location.href='./page1.html'">自學是什麼</button>\
                     ...
                     <button type="button" class="btn btn-item" id="btn7" onclick="location.href='./page7.html'">自律學習實踐研究會</button>\
